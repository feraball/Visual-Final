...
Public Class VentanaPlatilosPorRestaurante
    ...
    Private Sub frmVentanaPlatillos_Loaded(sender As Object, e As RoutedEventArgs) Handles frmVentanaPlatillos.Loaded
        ...
        txt_restaId.Visibility = Windows.Visibility.Visible
    ...
    Private Sub dtgPlatillosPorResta_SelectionChanged(sender As Object, e As SelectionChangedEventArgs) Handles dtgPlatillosPorResta.SelectionChanged
