...
Public Class VentanaClienteListar
    ...
    Private Sub txtIdPlatillo_TextChanged(sender As Object, e As TextChangedEventArgs)

    End Sub

    Private Sub dgPlatillosPorCategoria_MouseDoubleClick(sender As Object, e As MouseButtonEventArgs)

    End Sub

    Private Sub dgPlatillosPorCategoria_MouseDoubleClick_1(sender As Object, e As MouseButtonEventArgs) Handles dgPlatillosPorCategoria.MouseDoubleClick
        Dim filaSeleccionada = dgPlatillosPorCategoria.SelectedIndex
        ...
        Me.Hide()
        ventanaDescrip.Show()
        ventanaDescrip.txtIdPlati.Text = txtIdPlatillo.Text
